#!/usr/bin/env bash
# luau-analyze.sh — run luau-lsp's analyzer over MAGNET SWEEP's Luau, using the binary and Roblox type
# defs bundled with the VS Code luau-lsp extension.
#
# WHY THIS EXISTS (job 011): Studio Sync had silently dropped (PITFALLS #11) with a job's worth of code
